...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="PCA",
        choices=["PCA", "LLE"],
        help="The dim red. types",
    )
    parser.add_argument(
        "--n_comp", default=10, type=int, choices=[5, 10], help="output dimensions"
    )
    parser.add_argument(
        "--classifier", default="LR", choices=["LR", "SVC", "RF"], help="Classifiers"
    )
...
def main(args):
    X, y = make_classification(
        n_samples=1000, n_features=30, n_informative=15, n_redundant=15, random_state=42
    )
